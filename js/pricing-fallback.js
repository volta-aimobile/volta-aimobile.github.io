/* eslint-disable */
/**
 * Volta Pricing — CLIENT-SIDE FALLBACK TABLE
 * ===========================================
 * Auto-generated from api/_pricing.js (same table, same numbers, same rules).
 * Purpose: if /api/premium/price is unreachable (404 on an older Vercel
 * deployment, offline PWA use, first-load race), the client resolves the
 * regional price LOCALLY from the IANA timezone — so an Egyptian user
 * ALWAYS sees 29 EGP / 249 EGP, never the US fallback.
 * The server stays the authority when reachable (premium.js tries it first).
 */
(function () {
"use strict";
...
// ─── Browser global export (client-side fallback) ────────────────────────
window.VoltaPricingFallback = {
  priceForCountry,
  countryFromTimezone,
  resolvePrice,
  formatPrice,
