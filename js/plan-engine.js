...
window.VoltaPlan = (function () {
  ...
  function buildDietPlan(profile, survey, goalPlan) {
    ...
    // v46 (user: "also bring back snacks"): a SNACK row is part of EVERY
    // schedule again — it had quietly disappeared for 1-3 meals/day answers,
    // and the Gemini meal prompt generated no snack meals either (fixed in
    // volta.js). The plan always covers the full day; the meals-per-day
    // survey answer still feeds the AI coach context.
    var distribution;
    if (mealsPerDay === 1) {
      ...
      // the full day; v46 adds the snack row on top.
      distribution = [
