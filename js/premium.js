...
window.VoltaPremium = (function () {
  ...
  // ─── v43 (user): premium features are PREMIUM AGAIN ────────────────────
  // "non-premium users can use premium features when they go to profile -->
  //  go premium and when they click on any feature, it works without them
  //  needing to pay money, remove that"
  // The v29 "AI features free for everyone" bypass (AI_FREE_KEYS) is GONE.
  // Every launch point (FormSense, RepSense, ProgressIQ, RecoveryIQ) already
  // calls VoltaPremium.gate() first — with the bypass removed, free users
  // now land on the paywall modal instead of the feature, exactly like the
